...
namespace MES_F1.Migrations
{
    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Workers",
                columns: new[] { "WorkerId", "AccountId", "ApplicationUserId", "TeamId", "TeamRoleId", "WorkerName" },
                values: new object[,]
                {
                    { 1, null, null, null, null, "John Doe" },
                    { 2, null, null, null, null, "Jane Smith" },
                    { 3, null, null, null, null, "Alice Johnson" }
                });
